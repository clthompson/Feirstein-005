...
<div class="mobile-menu">
	...
	<div class="overlay">
		...
		<div class="admission-hero-introduction">
			<div class="content">
				<div class="title">
					<h4>Applications now accepted on a rolling basis until all places are filled.</h4>
		...
		<div class="admission-info">
			<div class="split-item  adm-requirements">
				...
				<article id="admissions-ma-cinemastudies">
					...
					<h5>Deadlines</h5>
					<p>Applications accepted on a rolling basis until all places are filled.</p>
					<h5>Contact</h5>
				...
				<article>
					...
					<h5>DEADLINES</h5>
					<p>Applications accepted on a rolling basis until all places are filled. Each specialization is capped at 14 students, except for screenwriting.</p>
					<h5>Contact</h5>
					<p><a href="http://www.brooklyn.cuny.edu/web/admissions/graduate.php" target="_blank">Office of Graduate Admissions</a></br>
						Brooklyn College</br>
						2900 Bedford Avenue</br>
			...
			<div class="split-item  tuition-financial-aid hidden">
				...
				<article>
                    ...
                    <P><a href=http://www.brooklyn.cuny.edu/web/academics/schools/mediaarts/schools/feirstein/creative_fund_2016.pdf>Creative Fund (pdf)</a></P>
